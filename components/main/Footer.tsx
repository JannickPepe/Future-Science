...
const Footer = () => {
    ...
    return (
        <div className="footer-body w-full h-full bg-transparent text-gray-200 shadow-lg p-[15px] z-50" >
            <div className="w-full flex flex-col items-center justify-center m-auto z-50">
